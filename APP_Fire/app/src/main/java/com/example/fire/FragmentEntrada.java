...
public class FragmentEntrada extends Fragment implements FragmentCompat.OnRequestPermissionsResultCallback, Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public FragmentEntrada() {
        // Required empty public constructor
    }

    public static FragmentEntrada newInstance(String text1, String text2) {
        FragmentEntrada fragmento2Dinamico = new FragmentEntrada();
        Bundle b = new Bundle();
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        vie =getActivity().getLayoutInflater().inflate(R.layout.fragment_entrada, container, false);
    ...
    private void cargarWebService() {
        ...
        String url= ip+"RegistroEntrada.php?matricula="+matri+"&herramienta="+herram+"&nombre="+nombre+"&fecha="+fecha;
        url = url.replace(" ","%20");
    ...
    public void onErrorResponse(VolleyError error) {
        progreso.hide();
        Toast.makeText(getContext(),"No se pudo registrar la entrada" + error.toString(),Toast.LENGTH_SHORT).show();
